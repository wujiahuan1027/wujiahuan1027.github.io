...
If ShowStyle = 1 Then '星期
    ...
    Response.Write "    }" & vbCrLf
    Response.Write "var strLinka='<a href=""#"" onclick=\'window.open(""User_SelectTime.asp?ShowStyle=0&DaySelect=';" & vbCrLf
...
Else
    ...
    Response.Write "var strLink='<a href=""#"" onclick=\'window.open(""User_SelectTime.asp?ShowStyle=0&DaySelect='+DaySelect+'"", ""strLesson"", ""width=600,height=450,toolbar=yes,menubar=yes, scrollbars=yes, resizable=yes, location=yes, status=yes"");\'>';" & vbCrLf
