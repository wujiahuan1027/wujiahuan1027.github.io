...
<table cellSpacing=0 cellPadding=0 width=778 align=center border=0>
  <tr>
    <td class=menu_s align=middle><%=GetChannel()%></td>
  </tr>
  <tr>
    <td><IMG height=7 src="../skin/Ocean/menu_bg2.jpg" width=778></td>
  </tr>
  <tr>
    <td background=<%= strInstallDir %>Skin/images/addr_line.jpg height=4></td>
  </tr>
</table>
...
<table class='top_tdbgall' style='word-break: break-all' cellSpacing='0' cellPadding='0' width='760' align='center' border='0'>
  ...
  <tr>
    <td><table class='top_Channel' cellSpacing='0' cellPadding='0' width='100%' border='0'>
      <tr>
        <td align=right><%=GetChannel()%></td>
      </tr>
    </table></td>
  </tr>
  <!--网站Logo和banner显示代码-->
  <tr>
    <td align=center><a href='#' title='首页' target='_blank'><img src='<%= strInstallDir %>Skin/Elegance/logo.gif' width='180' height='60' border='0'></a></td>
  </tr>
  <tr>
    <td><table width='100%' border='0' cellpadding='0' cellspacing='0' background='images/contmenu_bg.gif'>
      <tr>
...
<table width="1000" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr><td colspan="3" height="6"><img src="<%=strInstallDir%>Skin/sealove/space.gif"></td></tr>
    <tr><td width="14" height="34"><img src="<%=strInstallDir%>Skin/sealove/Top_01Left.gif"></td>
        <td background="<%=strInstallDir%>Skin/sealove/Top_01BG.gif" align="right" style="color:#FFFFFF"><%=GetChannel()%></td>
        <td width="14"><img src="<%=strInstallDir%>Skin/sealove/Top_01Right.gif"></td>
    </tr>
</table>
<table width="1000" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr><td width="4" background="<%=strInstallDir%>Skin/sealove/Top_02Left.gif"><img src="<%=strInstallDir%>Skin/sealove/space.gif"></td>
        <td background="<%=strInstallDir%>Skin/sealove/Top_02BG.gif">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr><td width="280" height="90" align="center"><a href='<%=SiteUrl%>' title='<%=SiteName%>' target='_blank'><img src='<%=strInstallDir%>skin/sealove/PElogo_sealove.gif' border='0'></a></td>
                <td align="center"><a href=\"http://www.powereasy.net\" target=\"_blank\"><img src="<%=strInstallDir%>Skin/sealove/PowerEasy_TOP.gif" border=\"0\"></a></td>
            </tr>
        </table>
        </td>
        <td width="4" background="<%=strInstallDir%>Skin/sealove/Top_02Right.gif"><img src="<%=strInstallDir%>Skin/sealove/space.gif"></td>
    </tr>
</table>
<table width="1000" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr><td width="17" background="<%=strInstallDir%>Skin/sealove/Top_03Left.gif"><img src="<%=strInstallDir%>Skin/sealove/space.gif"></td>
        <td  background="<%=strInstallDir%>Skin/sealove/Top_03BG.gif">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr><td width="20" height="33"><img src="<%=strInstallDir%>Skin/sealove/icon01.gif"></td>
                <td width="60">最新公告：</td>
                <td width="400"><img src="<%=strInstallDir%>Skin/sealove/space.gif"></td>
                <td align="right"><script language="JavaScript" type="text/JavaScript" src="<%=strInstallDir%>js/date.js"></script></td>
            </tr>
        </table>
        </td>
        <td width="17" background="<%=strInstallDir%>Skin/sealove/Top_03Right.gif"><img src="<%=strInstallDir%>Skin/sealove/space.gif"></td>
    </tr>
    <tr><td colspan="3" height="5"><img src="<%=strInstallDir%>Skin/sealove/space.gif"></td></tr>
</table>
<table width="1000" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr><td width="15"><img src="<%=strInstallDir%>Skin/sealove/Main_TopLeft.gif"></td>
        <td height="11" background="<%=strInstallDir%>Skin/sealove/Main_TopBG.gif"><img src="<%=strInstallDir%>Skin/sealove/space.gif"></td>
        <td width="15"><img src="<%=strInstallDir%>Skin/sealove/Main_TopRight.gif"></td>
    </tr>
</table>
<table width="1000" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr><td width="8" background="<%=strInstallDir%>Skin/sealove/Main_Left.gif"></td>
        <td>
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr><td width="135" height="60"><img src="<%=strInstallDir%>Skin/sealove/Main_Search.gif" alt="站内搜索"></td>
                <td><table cellSpacing=0 cellPadding=0 border=0>
                    <FORM name=search action=<%=strInstallDir%>search.asp method=post>
                    <tr><td align=middle><Input id=Keyword maxLength=50 value=关键字 name=Keyword></td>
                        <td align="center" width="55"><input name=Submit id=Submit type='image' src='<%=strInstallDir%>Skin/sealove/Icon_Search.gif' style='BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; BORDER-BOTTOM: 0px'></td>
                ...
                <td width="166" align="right"><img src="<%=strInstallDir%>Skin/sealove/Main_girl01.gif"></td>
            </tr>
        </table>
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr><td valign="top">
                <table width="98%" align="center" border="0" cellpadding="0" cellspacing="0" background="<%=strInstallDir%>Skin/sealove/Path_BG.gif">
                    <tr><td width="9"><img src="<%=strInstallDir%>Skin/sealove/Path_Left.gif"></td>
                        <td width="20"><img src="<%=strInstallDir%>Skin/sealove/icon02.gif"></td>
                        <td>您现在的位置：&nbsp;<a class='LinkPath' href='<%=SiteUrl%>'><%=SiteName%></a>&nbsp;>>&nbsp;会员中心</td>
                        <td width="84"><a href="<%=strInstallDir%>Reg/User_Reg.asp" target="_blank"><img src="<%=strInstallDir%>Skin/sealove/Button_Reg.gif" alt="会员注册" border="0"></a></td>
                        <td width="9"><img src="<%=strInstallDir%>Skin/sealove/Path_Right.gif"></td>
                    </tr>
                </table>
                </td>
                <td width="92" height="48" align="right" valign="top"><img src="<%=strInstallDir%>Skin/sealove/Main_girl02.gif"></td>
            </tr>
        </table>
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <td width="8" background="<%=strInstallDir%>Skin/sealove/Main_Right.gif"></td>
    </tr>
</table>
<table width="1000" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr><td width="8" background="<%=strInstallDir%>Skin/sealove/Main_Left.gif"></td>
...
Response.Write "stm_bm(['uueoehr',400,'','" & strInstallDir & "images/blank.gif',0,'','',0,0,0,0,0,1,0,0]);" & vbCrLf
...
Dim ChannelID, sqlChannel, rsChannel, ChannelName, ChannelShortName, ModuleName, ChannelDir
Dim rsHouseClass
sqlChannel = "select * from PE_Channel where ChannelType<=1 and ModuleType<>4 and ModuleType<>5 and Disabled=" & PE_False & " order by OrderID"
...
Do While Not rsChannel.EOF
    ...
    If ChannelID = 998 Then
        ...
        Response.Write "stm_aix('p1i0','p0i0',[0,'" & ChannelName & "管理','','',-1,-1,0,'User_" & ModuleName & ".asp?ChannelID=" & ChannelID & "','_self','User_" & ModuleName & ".asp?ChannelID=" & ChannelID & "','','','',6,0,0,'" & strInstallDir & "images/arrow_r.gif','" & strInstallDir & "images/arrow_w.gif',7,7,0,0,1,'#F1F2EE',1,'#CCCCCC',1,'','',3,3,0,0,'#FFFFF7','#FF0000','#ffffff','#ffff00','9pt 宋体','9pt 宋体']);" & vbCrLf
    ...
    If FoundInArr(arrClass_Input, ChannelDir & "none", ",") = False And ChannelID <> 997 And ChannelID <> 998 Then '增加不显示房产的条件
        Response.Write "stm_aix('p1i0','p0i0',[0,'" & ChannelName & "管理','','',-1,-1,0,'User_" & ModuleName & ".asp?ChannelID=" & ChannelID & "','_self','User_" & ModuleName & ".asp?ChannelID=" & ChannelID & "','','','',6,0,0,'" & strInstallDir & "images/arrow_r.gif','" & strInstallDir & "images/arrow_w.gif',7,7,0,0,1,'#F1F2EE',1,'#CCCCCC',1,'','',3,3,0,0,'#FFFFF7','#FF0000','#ffffff','#ffff00','9pt 宋体','9pt 宋体']);" & vbCrLf
        Response.Write "stm_bpx('p2','p1',[1,2,-2,-3,2,3,0,7,100,'filter:Glow(Color=#000000, Strength=3)',4,'',23,50,2,4,'#999999','#0089F7','',3,1,1,'#ACA899']);" & vbCrLf
        If CheckUser_ChannelInput(ChannelID, arrClass_Input) = True Then
...
Response.Write "stm_ep();" & vbCrLf
If eShop_Edition >= 0 And NoShow_Shop = False Then
    Response.Write "stm_aix('p0i2','p0i0',[0,'|','','',-1,-1,0,'','_self','','','','',0,0,0,'','',0,0,0,0,1,'#F1F2EE',1,'#CCCCCC',1,'','',3,3,0,0,'#FFFFF7','#FF0000','#ffffff','#ffff00','9pt 宋体','9pt 宋体']);" & vbCrLf
    ...
    Response.Write "stm_aix('p2i0','p0i0',[0,'在线支付','','',-1,-1,0,'../Shop/PayOnline.asp','_blank','../Shop/PayOnline.asp','','','',0,0,0,'','',0,0,0,0,1,'#F1F2EE',1,'#CCCCCC',1,'','',3,3,0,0,'#FFFFF7','#FF0000','#ffffff','#ffff00','9pt 宋体','9pt 宋体']);" & vbCrLf
    ...
    Else
        If rsspace("Passed") = True Then
            ...
            Do While Not rsitem.EOF
                ...
                Case 3
                    Response.Write "stm_aix('p0i0','p0i0',[0,'" & rsitem("Name") & "','','',-1,-1,0,'','_self','','','','',6,0,0,'" & strInstallDir & "images/arrow_r.gif','" & strInstallDir & "images/arrow_w.gif',7,7,0,0,1,'#F1F2EE',1,'#CCCCCC',1,'','',3,3,0,0,'#FFFFF7','#FF0000','#ffffff','#ffff00','9pt 宋体','9pt 宋体']);" & vbCrLf
            ...
            End If
            Response.Write "stm_aix('p2i0','p0i0',[0,'查看我的聚合','','',-1,-1,0,'../Space/" & UserName & "/','_blank','../Space/" & UserName & "','','','',0,0,0,'','',0,0,0,0,1,'#F1F2EE',1,'#CCCCCC',1,'','',3,3,0,0,'#FFFFF7','#FF0000','#ffffff','#ffff00','9pt 宋体','9pt 宋体']);" & vbCrLf
        Else
...
Response.Write "stm_bpx('p2','p0',[1,4,0,6,2,3,6,7,100,'filter:Glow(Color=#000000, Strength=3)',4,'',23,50,2,4,'#999999','#0089F7','',3,1,1,'#ACA899']);" & vbCrLf
Response.Write "stm_aix('p0i0','p0i0',[0,'好友列表','','',-1,-1,0,'','_self','','','','',6,0,0,'" & strInstallDir & "images/arrow_r.gif','" & strInstallDir & "images/arrow_w.gif',7,7,0,0,1,'#F1F2EE',1,'#CCCCCC',1,'','',3,3,0,0,'#FFFFF7','#FF0000','#ffffff','#ffff00','9pt 宋体','9pt 宋体']);" & vbCrLf
Response.Write "stm_bpx('p2','p0',[1,2,-2,-3,2,3,0,7,100,'filter:Glow(Color=#000000, Strength=3)',4,'',23,50,2,4,'#999999','#0089F7','',3,1,1,'#ACA899']);" & vbCrLf
...
If UserType = 0 And CRM_Edition > 0 Then
...
If request("Action") <> "ReadInbox" Then
    ...
    If MessageID > 0 Then
        ...
        Response.Write "var url = 'User_ReadMessage.asp?MessageID=" & MessageID & "';" & vbCrLf
...
Function GetChannel()
    ...
    strChannel = "&nbsp;|&nbsp;<a class='Channel' href='" & strInstallDir & "Index" & GetFileExt(FileExt_SiteIndex) & "'>首页</a>&nbsp;|&nbsp;"
    ...
    Do While Not rsChannel.EOF
        If rsChannel("Disabled") <> True And (rsChannel("ShowName") <> False Or rsChannel("ChannelType") = 2) Then
            ...
            If rsChannel("ChannelPicUrl") = "" Or IsNull(rsChannel("ChannelPicUrl")) = True Then
                strChannel = strChannel & ">" & rsChannel("ChannelName") & "</a>&nbsp;|&nbsp;"
            Else
                strChannel = strChannel & "><img src='" & rsChannel("ChannelPicUrl") & "' border=0 alt='" & rsChannel("ChannelName") & "'></a>&nbsp;|&nbsp;"
            End If
        End If
        rsChannel.MoveNext
    Loop
