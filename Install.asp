...
Response.Write "<title>动易网站管理系统安装向导</title>" & vbCrLf
...
Sub Step1()
    ...
    Response.Write "    <tr class='topbg'>" & vbCrLf
    Response.Write "      <td height='22' colspan='2' align='center'><strong>动易网站管理系统安装向导</strong></td>" & vbCrLf
    Response.Write "    </tr>" & vbCrLf
    Response.Write "    <tr class='tdbg'>" & vbCrLf
...
Sub Step2()
    ...
    Call CreatSkinFile
    Call ClearSiteCache
    Call WriteSuccessMsg("系统安装完成！现在你可以使用系统了。<br>为了<font color='red'>系统安全</font>，请点击下面的按钮删除此安装文件（Install.asp）<br><br><div align='center'><input name='delfile' type='button' id='delfile' value=' 删除此安装文件 ' onclick=""location='install.asp?Action=Stepdel'""></div><br>", ComeUrl)
End Sub
...
Sub Stepdel()
    ...
    If Err.Number <> 0 Then
        ...
        Exit Sub
    Else
        Call WriteSuccessMsg("删除此安装文件（Install.asp）成功！", ComeUrl)
    End If
