            ...
            If rsAD("LinkUrl") <> "" Then
                If rsAD("CountClick") = True Then
                    ...
                    Else
                        strInstallDir = InstallDir
                    End If
                    ADLinkUrl = strInstallDir & PE_CStr(Conn.Execute("select ADDir from PE_Config")(0), "AD") & "/ADCount.asp?Action=Click&ADID=" & rsAD("ADID")
                Else
...
Function PE_CStr(ByVal str1, ByVal str2)
    If IsNull(str1) Then
        PE_CStr = str2
    Else
        PE_CStr = CStr(str1)
