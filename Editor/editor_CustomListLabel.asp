...
Dim Action, Title, ModuleType, ChannelShortName, ChannelShowType, imageproperty
...
Response.write "        <Input id=DateNum maxLength=3 size=5 value=30 name=DateNum> 天内更新的" & ChannelShortName & "&nbsp;&nbsp;&nbsp;&nbsp;<FONT color=#ff0000>&nbsp;&nbsp;如果为空或0，则显示所有天数的文章。</FONT></td>" & vbCrLf
Response.write "    </tr>" & vbCrLf
Response.write "    <tr class=tdbg>" & vbCrLf
