...
<table width="100%" border="0" cellpadding="6" cellspacing="0">
  <tr> 
    <td align="center" bgcolor="#0066FF"><b><font color="#ffffff">动易网站管理系统HTML在线编辑器使用帮助</font></b></td>
  </tr>
  <tr> 
  ...
  2、可自动识别各种网址和Email地址，可增加或取消链接、插入特殊水平线等功能，支持从word中粘贴内容并去除冗余代码。<br>
        ...
        8、如果要手动书写源代码，请选中“源代码”视图模式。支持所有的HTML标签。支持动网论坛的大部分UBB代码（需要在显示文章时调用动网论坛的UBB转换函数）。 
