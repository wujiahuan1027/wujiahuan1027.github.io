...
Sub main()
    Dim EnableSoftKey
    EnableSoftKey = Conn.Execute("select EnableSoftKey from PE_Config")(0)
    ...
    Response.Write "  }" & vbCrLf
    Response.Write "}" & vbCrLf
    Response.Write "function refreshimg(){document.all.checkcode.src='../inc/checkcode.asp';}" & vbCrLf
    Response.Write "//-->" & vbCrLf
    ...
    If EnableSiteManageCode = True And SiteManageCode = "PowerEasy2006" Then
        Response.Write "      <br><center><font color=""red"">您使用的后台管理认证码为系统初始值“PowerEasy2006”，请修改Admin_ChkCode.asp文件中相应的SiteManageCode值。</font></center>" & vbCrLf
    End If
