...
Sub SaveConfig()
    If ObjInstalled = False Then
        ...
        Exit Sub
    End If
    Set hf = FSO.CreateTextFile(Server.MapPath(strInstallDir & AdminDir & "/RootClass_Menu_Config.asp"), True)
...
Sub Create_RootClass_Menu()
    ...
    If Not FSO.FolderExists(Server.MapPath(strInstallDir & ChannelDir & "/js")) Then
        FSO.CreateFolder Server.MapPath(strInstallDir & ChannelDir & "/js")
    End If
    Set hf = FSO.CreateTextFile(Server.MapPath(strInstallDir & ChannelDir & "/js/ShowClass_Menu.js"), True)
    hf.Write strTopMenu
    hf.Close
        ...
        If rsClass("ClassType") = 1 Then
            If rsClass("Child") > 0 Then
                If UseCreateHTML > 0 And rsClass("ClassPurview") < 2 Then
                    Select Case ListFileType
                    Case 0
                        strJS = strJS & stm_aix("p" & pNum & "i" & k & "", "p" & pNum2 & "i0", rsClass("ClassName"), ChannelUrl & rsClass("ParentDir") & rsClass("ClassDir") & "/Index." & FileExt_List, OpenType_Class, Sub_MenuTitle, True) & vbCrLf
                    Case 1
            ...
            Else
                If UseCreateHTML > 0 And rsClass("ClassPurview") < 2 Then
                    Select Case ListFileType
                    Case 0
                        strJS = strJS & stm_aix("p" & pNum & "i" & k & "", "p" & pNum2 & "i0", rsClass("ClassName"), ChannelUrl & rsClass("ParentDir") & rsClass("ClassDir") & "/Index." & FileExt_List, OpenType_Class, Sub_MenuTitle, False) & vbCrLf
                    Case 1
...
Function stm_bm()
    stm_bm = "stm_bm(['uueoehr',400,'','" & SiteUrlInstallDir & "images/blank.gif',0,'','',0,0,0,0,0,1,0,0]);"
End Function
...
Function stm_aix(mOID, mTID, mClassName, mClassFile, mOpenType, mMenuTitle, mSubClass)
    ...
    ElseIf mSubClass = True Then
        stm_aix = "stm_aix('" & mOID & "','" & mTID & "',[0,'" & mClassName & "','','',-1,-1,0,'" & mClassFile & "','" & mOpenType & "','" & mClassFile & "','" & EncodeJS(mMenuTitle) & "','','',6,0,0,'" & SiteUrlInstallDir & "images/arrow_r.gif','" & SiteUrlInstallDir & "images/arrow_w.gif',7,7,0," & RCM_Item_22 & "," & RCM_Item_23 & ",'" & RCM_Item_24 & "'," & RCM_Item_25 & ",'" & RCM_Item_26 & "'," & RCM_Item_27 & ",'" & RCM_Item_28 & "','" & RCM_Item_29 & "'," & RCM_Item_30 & "," & RCM_Item_31 & "," & RCM_Item_32 & "," & RCM_Item_33 & ",'" & RCM_Item_34 & "','" & RCM_Item_35 & "','" & RCM_Item_36 & "','" & RCM_Item_37 & "','" & FontSize_RCM_Item_38 & " " & FontName_RCM_Item_38 & "','" & FontSize_RCM_Item_39 & " " & FontName_RCM_Item_39 & "']);"
    End If
End Function
