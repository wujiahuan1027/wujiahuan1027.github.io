...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="20">&nbsp;</td>
    <td width="400" valign="top">　　本功能<a href="Admin_CreateIndex.asp" target="main">将</a><a href="Admin_CreateIndex.asp" target="main">从系统备份的数据库</a>中恢复数据库。请注意备份数据库路径相对路径，并输入正确的数据库名。<br>
