...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td height="114" valign="top" background="Images/adminmain0line2.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><div id="peinfo1">正在读取数据中...</div><div id="peinfo2" style="z-index: 1; visibility: hidden; position: absolute"></div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="20" rowspan="2">&nbsp;</td>
    <td width="100" align="center" class="topbg"><a class='Class' href="Admin_CreateIndex.asp" target="main">首页生成管理</a></td>
    <td width="300">&nbsp;</td>
    <td width="40" rowspan="2">&nbsp;</td>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="20">&nbsp;</td>
    <td width="400">　　首次安装系统请<a href="Admin_CreateIndex.asp" target="main"><font color="#FF0000">生成网站首页</font></a>。首页、栏目页、内容页、专题页……都可以生成完全的HTML页面（评论和点击数统计除外）。各频道启用生成功能请在<a href=Admin_Channel.asp target=main title="动易网站管理系统中，频道是指某一功能模板的集合。某一频道可以是具备文章系统功能，或具备下载系统、图片系统的功能。"><U><font color="#FF0000">网站频道管理</font></U></a>中设置。</td>
    <td width="40">&nbsp;</td>
