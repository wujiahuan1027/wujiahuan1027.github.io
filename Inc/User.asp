...
Sub ShowInfo(iUserID, ShowCompanyInfo)
    ...
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'>"
    Response.Write "    <td width='14%' align='right' class='tdbg5'>会员组别：</td><td width='36%'>" & GetGroupName(rsUser("GroupID")) & "</td>"
    ...
    Response.Write "                        <td>" & GetArrItem(Array("保密", "女", "男"), Sex + 1) & "</td>" & vbCrLf
    ...
    Response.Write "                        <td>" & GetArrItem(arrIncome, Income) & "</td>" & vbCrLf
    Response.Write "                    </tr>" & vbCrLf
    Response.Write "                  </tbody>" & vbCrLf
